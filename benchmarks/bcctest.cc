...
main(int argc, char **argv)
{
  ...
  void (*test_fn)(ndb_wrapper *, size_t, int, char** ) = NULL;
  test_fn = bcctest;
...
#ifdef USE_BCC
  ::allocator::InitializeWorkerMemory(nthreads);
#endif
  ...
  if (disable_snapshots) {
    ...
    ndb_wrapper *db = new ndb_wrapper(
        logfiles, assignments, !nofsync, do_compress, fake_writes,nthreads);
